                  ...
                  <section className=" py-24 overflow-hidden ">
                      <div className=" max-w-7xl mx-5 xl:mx-auto relative ">
                          ...
                          <div className=" flex justify-center items-center gap-x-5 mt-8 relative z-10">
                              <Button href="#" className=" text-[#995FB6] dark:text-new-yellow flex justify-center rounded-full text-lg bg-black dark:bg-[#241d0b] border-2 !py-2 h-auto !px-6 dark:border-new-yellow border-[#995FB6] items-center gap-x-2 font-semibold"><GoDownload className="dark:text-new-yellow text-[#995FB6] h-5 w-5" /> Resume</Button>
                              <Button href="#" className="h-auto bg-[#995FB6] dark:bg-new-yellow dark:hover:bg-new-yellow-700 text-black flex justify-center rounded-full text-lg  border-2 !py-2 !px-8 border-[#995FB6] dark:border-new-yellow items-center font-semibold gap-x-2">Hire Me</Button>
                          </div>
