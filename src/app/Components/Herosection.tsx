        ...
        <>
            <section className=" py-24 overflow-hidden ">
                <div className=" max-w-7xl mx-5 xl:mx-auto relative ">
                    ...
                    <p className=" text-2xl text-black dark:text-white text-center mt-4 relative z-10"><span className=" font-semibold">FullStack Frontend Developer | Web Designer</span> </p>
                    <p className=" text-lg  text-black dark:text-white text-center mt-2 relative z-10">with <span className=" mx-2 border-2 border-[#2f2f2f] dark:border-[#2f2f2f] bg-[#241d0b] px-3 py-1 rounded-2xl dark:bg-[#241d0b] text-[#995FB6] dark:text-new-yellow ">2.0+ Years</span> Experience</p>
                    ...
                    <div className=" relative mt-20 md:mt-40">
                        ...
                        <div className=" relative  md:absolute top-0 z-10">
                            ...
                            <div
                                ...
                                <div
                                    className=" flex items-center animate-wave2 justify-center gap-x-3 bg-[#995FB6] dark:bg-white py-2 md:py-5 px-5 md:px-7 rounded-full ">
                                    <Image src="/images/herosection/react.svg" alt='icon'
                                        className=" h-[30px] w-[30px] md:h-[50px] md:w-[50px]" height="50"
                                        width="50" />
                                    <p className=" text-lg md:text-2xl font-semibold text-black">React Native</p>
                                </div>
                                <div
